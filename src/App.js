...
class App extends Component {
  state = {randomImage: '', activeTab: tabsList[0].tabId}
  ...
  renderRandomImage = () => {
    ...
    return <img className="match-image-class" src={randomImage} alt="match" />
  }
      ...
      <div className="header-container">
        ...
        <div className="score-timer-container">
          <p className="score-name">
            score: <span className="span-timer-class">0</span>
          </p>
          <div className="timer-container">
            <img
              ...
              alt="timer"
            />
            <p className="span-timer-class">60 sec</p>
          </div>
        </div>
      </div>
    )
  ...
  render() {
    ...
    const randomImageUrl = this.generateRandomImage()
    return (
      <div className="app-container">
        {this.renderHeader()}
        <img className="match-image-class" src={randomImageUrl} alt="match" />
        <ThumbnailContainer
          tabList={tabsList}
          activeTab={activeTab}
          tabChange={this.onChangeActiveTab}
        />
      </div>
    )
  }
